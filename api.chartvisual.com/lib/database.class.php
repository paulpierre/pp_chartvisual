<?php
class Database {
	public function db_update($table_name,$db_columns,$db_conditions,$isOr=false,$db_database=DATABASE_NAME)
	{
    ...
    public function db_create($table_name,$db_columns,$db_database=DATABASE_NAME)
    {
        //print_r($db_columns);
    ...
    public function db_retrieve($table_name,$db_columns,$db_conditions='',$db_extra=null,$isOr=false,$db_database=DATABASE_NAME)
    {
